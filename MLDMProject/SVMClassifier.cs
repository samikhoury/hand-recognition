...
namespace MLDMProject
{
    ...
    {
        public MulticlassSupportVectorMachine machine { get; set; }
        ...
        public SVMClassifier(int input, int output)
        {
            this.input = input;
            this.output = output;
        ...
        {
            double[][] dataInputs = Utility.toDoubleArrayEFDBased(observations);
            int[] dataOutputs = Utility.labelsToIntArray(observations);
            gaussian = Gaussian.Estimate(dataInputs);
            machine = new MulticlassSupportVectorMachine(input, gaussian, output);
            MulticlassSupportVectorLearning teacher = new MulticlassSupportVectorLearning(machine, dataInputs, dataOutputs);
        ...
        {
            int output = machine.Compute(newObsrv.efd);
